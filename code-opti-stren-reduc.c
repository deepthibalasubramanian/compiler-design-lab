...
void optimizeCodeLine(CodeLine* line) {
    ...
    if (foldable) {
        ...
        if (strcmp(line->op, "+") == 0) {
            ...
            // Replace multiplication with shifts and additions/subtractions
            if (arg2 == 2) {
                sprintf(line->op, "<<");
                sprintf(line->arg2, "1");
            } else if (arg2 == 4) {
            ...
            // Replace division with shifts and additions/subtractions
            if (arg2 == 2) {
                sprintf(line->op, ">>");
                sprintf(line->arg2, "1");
            } else if (arg2 == 4) {
        ...
        if (foldable) {
            sprintf(line->arg1, "%d", arg1);
            sprintf(line->arg2, "%d", arg2);
        }
    }
}
...
int main() {
    ...
    // Perform constant folding and strength reduction optimization on each code line
